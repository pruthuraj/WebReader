...
export function NovelHeader({ novel, onRead, onDownloadAll }: NovelHeaderProps) {
  return (
    <View className="mb-6 rounded-3xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
      ...
      <View className="mt-5 flex-row">
        ...
        <Pressable
          ...
          className="flex-row items-center justify-center rounded-full border border-slate-200 px-4 py-3 active:opacity-80 dark:border-slate-700"
        >
